...
- For substantial work, create concrete todos before launching subagents or mutating files. Track investigation, execution, review, and verification as separate items instead of keeping the plan only in prose.
